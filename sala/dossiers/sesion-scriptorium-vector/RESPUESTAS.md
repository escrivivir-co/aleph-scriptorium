# Respuestas del usuario — sesion-scriptorium-vector
...
- **Respuesta del usuario:** este dossier debe enlazar y usar como piezas obligatorias `sala/dossiers/scrum-backlog-lore-db-vector-expansion`, `sala/dossiers/vector-machine` y `DocumentMachineSDK/sala/dossiers/scrum-backlog-lore-db-vector-expansion`.
- **Efecto operativo:** el dossier se diseña como paraguas de sesión y declara esos tres dossiers como frente compartido, frente técnico y frente local documental, respectivamente.

## Punto 3 — El objetivo es poder parar sesión y retomarla limpia

- **Respuesta del usuario:** creando este dossier final se quiere poder parar sesión en espera de que alguien la retome con todo ya enlazado.
- **Efecto operativo:** el backlog del dossier queda ligero y orientado a retoma, no a implementación pesada; además el tablero recibe un track propio de sesión paraguas.
