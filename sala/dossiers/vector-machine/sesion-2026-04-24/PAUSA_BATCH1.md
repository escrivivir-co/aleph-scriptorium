...
## Decisión de Aleph al archivar (2026-04-24)

**Opción B — liberadas.** VMI-01..VMI-08 vuelven a `libre` en el tablero. Próximo agente que tome el batch puede arrancar leyendo este documento para no repetir investigación. Gepe queda disponible para nueva sesión.
