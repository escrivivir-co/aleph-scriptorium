...
escenas:
  ...
  - id: 2
    ...
    contenido_ref: 02-biblioteca.md
  - id: 3
    ...
    feature: "@periodico"
    contenido_ref: 03-hemeroteca.md
  - id: 4
    ...
    contenido_ref: 04-scriptorium.md
  - id: 5
    nombre: "El Foro"
    anillo: 2
    tipo: umbral
  ...
  - id: 6
    ...
    contenido_ref: 06-laboratorio.md
  - id: 7
    nombre: "El Teatro"
    anillo: 2
    tipo: cueva
  ...
  - id: 9
    ...
    contenido_ref: 09-publicacion.md
  - id: 10
    nombre: "El Mapa"
    anillo: 3
    tipo: retorno
  ...
  - id: 11
    ...
    contenido_ref: 11-integracion.md
  - id: 12
    nombre: "El Elixir"
    anillo: 3
    tipo: elixir
