...
.leeme-table .status-ok { color: #4ade80; }
.leeme-table .status-dev { color: #fbbf24; }
.leeme-table .status-research { color: #60a5fa; }
...
<div style="text-align: center; margin-top: 4rem; padding: 2rem 0; border-top: 1px solid #333;">
  <p style="color: #666; font-family: monospace; font-size: 0.9rem;">
    ¿Listo para empezar? → <a href="{{ site.baseurl }}/agentes/">Explora los agentes</a> · 
    <a href="{{ site.baseurl }}/fundacion/">Lee Fundación</a> · 
