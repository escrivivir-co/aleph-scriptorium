...
**Fecha**: 2025-12-29 — **Sprint**: PRE — **Épica**: SCRIPT-1.31.0 — **Estado**: ✅ Completada (30 pts)

Integración del submódulo CopilotEngine como fuente ReadOnly de conocimiento sobre el sistema de mensajería de VS Code Copilot Chat. Análisis completo del flujo User Prompt → System Message → LLM → Output.

**Palabras clave**

copilot, engine, system, messaging, typescript, prompt-tsx, mermaid, promptregistry

**Titulares**

- SCRIPT-1.31.0: Análisis System Messaging (CopilotEngine)
- Flujo User Prompt → LLM Output por Agente y Modelo
- Mapeo de Prompts por Modelo (Claude, GPT, Gemini)
- Diagrama Mermaid del flujo completo

**Ideas fuerza**

- **ReadOnly source**: Entender el System Messaging de VS Code Copilot Chat
- **Mapeo ontológico**: IAgentPrompt → instrucciones, PromptRegistry → carga dinámica
- **5 Stories completadas**: S01-S05 (investigación + integración)
- **Agentes actualizados**: @ox, @aleph, @indice con conocimiento de CopilotEngine

**Archivos**

- [01_backlog-borrador.md — Backlog Borrador: SCRIPT-1.31.0](COPILOT_ENGINE/01_backlog-borrador.md)
...
**Fecha**: 2025-12-24 (actualizado 2025-12-30) — **Estado**: ✅ COMPLETADO

Renombrado de 14 submódulos desde naming técnico (`alephscript-*`, `as-*`) a convención **PascalCase descriptiva** (FunciónTipo). Mejora significativa en legibilidad del workspace.
...
- Taxonomía por Función: Gallery, Editor, Suite, Desktop, Extension
- Mapeo Completo (v2 — Diciembre 2025)

**Ideas fuerza**

- [x] Eliminar referencias `alephscript`, `as-`, prefijos técnicos
- [x] Nuevo patrón: **PascalCase descriptivo** que indique función
- [x] Ejemplo: `alephscript-n8n-like-editor` → `WorkflowEditor`
- [x] **14 submódulos renombrados** (verificado 2025-12-30)

**Archivos**

- [BUG-003-renombrar-submodulos-a-ah.md — BUG-003 — Renombrar submódulos](SUBMODULOS_AH_NAMING/BUG-003-renombrar-submodulos-a-ah.md)
...
## Diciembre_29_Blueprint_Copilot_Cube

**Abstract**

**Fecha**: 2025-12-29 — **Sprint**: PRE — **Épica**: SCRIPT-1.31.1 — **Estado**: ✅ Completada

Blueprint 3D con navegación impress.js que visualiza el flujo de Copilot Chat: User Prompt → System Message → LLM → Output. Cubo interactivo con 6 caras representando componentes del sistema.

**Palabras clave**

blueprint, copilot, cube, 3d, impress, navegación, system-message, llm

**Titulares**

- Backlog Borrador: SCRIPT-1.31.1 — Blueprint Copilot 3D Cube
- Conversación PO-SM: Diseño del cubo interactivo

**Ideas fuerza**

- Visualización 3D del flujo de prompt processing
- Cada cara del cubo = componente del sistema Copilot
- Navegación impress.js con rotaciones 3D

**Archivos**

- [01_backlog-borrador.md — Backlog Borrador: SCRIPT-1.31.1](Diciembre_29_Blueprint_Copilot_Cube/01_backlog-borrador.md)
- [conversacion-po-sm.md — Conversación PO-SM](Diciembre_29_Blueprint_Copilot_Cube/conversacion-po-sm.md)
...
**Fecha**: 2025-12-29 — **Sprint**: PRE — **Épica**: SCRIPT-2.1.0 — **Estado**: 📋 Activo

Context Manager para TypedPrompting: sistema que permite cargar/descargar packs de contexto según el foco del trabajo (blueprint, scrum, teatro, full). Incluye refinamiento del agente @indice, integración de MCPGallery/servidores, y resolución DevOps.

**Palabras clave**

typedprompting, context, manager, packs, mcp, indice, devops, agente

**Titulares**

- Backlog Borrador: SCRIPT-2.1.0 — TypedPrompting Context Manager
- Evidence: Agent Logs and Refactor
- Refinamiento Agente Índice
- Integración MCPGallery Servidores
- Resolución DevOps ContextManager

**Ideas fuerza**

- **Context Packs**: Agrupaciones de instrucciones, agentes y tools por foco
- **Carga dinámica**: Activar/desactivar packs según necesidad
- **Mitigación de bloat**: Solo cargar lo necesario para la tarea actual
- **10 documentos de trabajo**: Desde backlog hasta resolución DevOps

**Archivos**

- [01_backlog-borrador.md — Backlog Borrador Principal](Diciembre_29_TypedPrompting_ContextManager/01_backlog-borrador.md)
- [02_evidence_agent_logs_and_refactor.md — Evidencia y Logs](Diciembre_29_TypedPrompting_ContextManager/02_evidence_agent_logs_and_refactor.md)
- [03_conversacion-refinamiento-backlog.md — Refinamiento Backlog](Diciembre_29_TypedPrompting_ContextManager/03_conversacion-refinamiento-backlog.md)
- [04_Revision_Agente_Indice.md — Revisión @indice](Diciembre_29_TypedPrompting_ContextManager/04_Revision_Agente_Indice.md)
- [05_Refinamiento_Agente_Indice.md — Refinamiento @indice](Diciembre_29_TypedPrompting_ContextManager/05_Refinamiento_Agente_Indice.md)
- [06_Decision_PO_Refactorizar.md — Decisión PO](Diciembre_29_TypedPrompting_ContextManager/06_Decision_PO_Refactorizar.md)
- [07_Refinamiento_Agente_McpPresets.md — Refinamiento @mcp-presets](Diciembre_29_TypedPrompting_ContextManager/07_Refinamiento_Agente_McpPresets.md)
- [08_Formacion_McpPresets_MCP_Server.md — Formación MCP Server](Diciembre_29_TypedPrompting_ContextManager/08_Formacion_McpPresets_MCP_Server.md)
- [09_Integracion_MCPGallery_Servidores.md — Integración MCPGallery](Diciembre_29_TypedPrompting_ContextManager/09_Integracion_MCPGallery_Servidores.md)
- [10_Resolucion_DevOps_ContextManager.md — Resolución DevOps](Diciembre_29_TypedPrompting_ContextManager/10_Resolucion_DevOps_ContextManager.md)

---

## Diciembre_30_CopilotLogExporter

**Abstract**

**Fecha**: 2025-12-30 — **Sprint**: PRE — **Épica**: SCRIPT-2.1.1 — **Estado**: ✅ Completada

Servidor MCP para exportar logs de conversaciones de Copilot Chat. Permite capturar el flujo completo User→System→LLM→Output para análisis y debugging de prompts.

**Palabras clave**

copilot, log, exporter, mcp, server, conversacion, debug, prompts

**Titulares**

- Backlog Borrador: SCRIPT-2.1.1 — Copilot Log Exporter MCP
- Conversación PO-SM: Diseño del servidor MCP
- Prompt de investigación CCREQ

**Ideas fuerza**

- **Exportación de logs**: Captura completa de conversaciones
- **Servidor MCP**: Integración con mesh de servidores DevOps
- **Debugging de prompts**: Análisis de flujo real vs esperado

**Archivos**

- [01_backlog-borrador.md — Backlog Borrador Principal](Diciembre_30_CopilotLogExporter/01_backlog-borrador.md)
