...
> **Ficha de etiquetas**
> [![animus iocandi](https://img.shields.io/badge/animus-iocandi-8A2BE2?style=for-the-badge)](https://github.com/escrivivir-co/aleph-scriptorium/blob/integration/beta/scriptorium/LICENSE.md) ![nsfw](https://img.shields.io/badge/NSFW-FF4D4F?style=for-the-badge) ![PoC](https://img.shields.io/badge/PoC-00A86B?style=for-the-badge) ![WIP](https://img.shields.io/badge/WIP-F59E0B?style=for-the-badge) ![this is a plan, the picture of an IDEA](https://img.shields.io/badge/this%20is%20a%20plan%2C%20not%20a%20product%20picture-1F2937?style=for-the-badge)
...
| Sound System | Transmedia-System | Contrato operativo | Cuidado editorial |
|--------------|-------------------|--------------------|-------------------|
| Selector | Equipo de Ceremonias / Arrakis Theater | Curar sesión, abrir/cerrar Room, animar turnos y canon. | No convertirlo en narrador omnipotente. |
| Operator / Engineer | MCP + PRESETS | Publicar capacidades, permisos, presets y seguridad de herramientas. | No confundir control técnico con autoridad narrativa. |
| Deejay / Chanter | Dramaturgo/Demiurgo | Conectar la ventana de contexto y sostener la forma emocional y pública del corpus. | En principio la máquina de future ya permite grafo-universo para recortar y "determinar". No tanto "crear" como operar el sistema emergente |
| Box Boys / Crew | Aleph, Ox & cía | Ciclo DevOps y bucle de CD/CI con versionado semántico. Montar transporte, salud, observabilidad y recuperación. | No hacer que la infraestructura dicte la cultura. |
| Massive | Personas que juegan / Red de T.A.Z.s | Intervenir, elegir, descubrir, devolver señales. | No reducirlas a métricas de engagement. |
| Turntables + Mic | Stream + feeds + rude bots + rooms + network-meshes. Transmedia: text + audio + video hipervinculada. | Canal multívoco (muchos orígenes, poco espacio de la decoherencia del continuo-espacio tiempo, en las sesiones) señal viva multimodal. | No equilibrar entre modos Dancing-Chill (acción sin retorno) y Sound Clashes (marcos con protocolo) |
...
Para comprender detalladamente las 4 libertades esenciales que rigen a GNU/Linux y todo el ecosistema de software libre:
...
Estas libertades se administran mediante licencias (como la licencia pública general o [GNU GPL](https://www.google.com/url?sa=i&source=web&rct=j&url=https://www.gnu.org/licenses/gpl-3.0.html&ved=2ahUKEwiQkoz3ku6UAxXIQ6QEHf_ILaIQy_kOegoIAggACAAIEBAC&opi=89978449&cd&psig=AOvVaw3k-gBCwuWes59IK9f19Yh7&ust=1780681843304000)) que aseguran el concepto de *copyleft*, evitando que el código pase a ser cerrado o privativo. [[1](https://www.youtube.com/watch?v=IK1AtNCfExo&vl=es&t=15), [2](https://www.rebiun.org/node/2830), [3](https://www.fing.edu.uy/~asabigue/prgrado/2004eofgl/contenido/anexo2/anexo_ii_24.html)]


| Sound System | Transmedia-System | Contrato operativo | Cuidado editorial |
|--------------|-------------------|--------------------|-------------------|
| Scoops / subgraves | Corpus / lore versionable | Sostener continuidad profunda del mundo en alguna suerte de editor que permita acceso vectorial a espacios enciclopédicos (somos afines a mediawiki). El libro no como artefacto que consumirá un humano sino como hiperlibro semántico. No como espacio euclidiano sino de hilbert. | No equilibrar entre canon dogma operativo y otras zonas del corpus menos relacionadas como poemarios y otros corpus autocontenidos. |
| Mid-boxes | Grafo de futuros | Dar agencia, tensión y ramas jugables. Decía Zizek que el encuentro con los Otros no debe tener el viaje. ¡Sigamos! Un grafo o un universo son world-models: las páginas de un hiperlibro no son thread como en los libros, son activaciones de inercias, masas en el sistema de referencia del modelo, that simple! | No operar los grafos y universos generados en la ventana de contexto según sus reglas o ausencia del equipo de ceremonias para dirimir reportes. El equivalente a "hacer trampas". Pactar si se vale antes de empezar para crear escenarios donde además de participar haya que preocuparse de la meta-validez del juego y dedicar tiempo a gestionar justicia. |
| Tweeters / horns | [Obra / ParaLaVozSDK](https://escrivivir-co.github.io/para-la-voz-sdk/) | El SDK va sobre la hipótesis de que una "ventana de contexto" puede destilarse desde un corpus; y que corremos esa ventana de contexto en un LLM quienes le oyen hablar y han creado el corpus reconocen "una voz" que lo representa. | No hacer como Anthropic cortando los lomos de los libros y tirándolos a la hora de querer aprender una voz. Lo ideal sería que las propias personas que escriben crearan versiones de sus libros con propiedades emergentes de tipo hiperlibro. |
| Camión + cableado | WSS, Pub.Rooms, Caddy, Peer Cards | Llevar la presión narrativa a barrios digitales (a pesar, so pena los tecno-cercos que protegen sus granjas de engagement. ¿Podrán los rude bots, estos pequeños skins ácratas, a modo de trajes de ultrahéroe con todo de herramienta agénticas viajar en las ergosferas para atravesar las murallas feudales y aparecer dentro como transmedia?). La pregunta, ¿no se crearon autopistas de la información? ¿qué pasa que no hay carreteras de la información (WAN)? ¿Y no hay pueblos al pie de esas vías más lentas (LAN)? ***KEEP CALM & Book a Party for your town!*** | No convertir federación en dependencia central opaca. |
| Sound clash | ARG Router / encuentro entre comunidades | Federar voces, representantes y ventanas de contexto. El clashing es el proceso por el cual lo cognados se abre o la luz se abre en espectro y durante un marco de juego los colores o términos que han divergido allende sus coherencias (ventanas de contexto) en la correlación de fuerzas. Las facciones se turna e interactúan alternándose o en sincronía. | No simular debate si las comunidades no tienen agencia real. |
| Sello discográfico | Escrivivir.co | Curar catálogo, giras, identidades y continuidad editorial. Es revista ficticia, apófrica, como el proyecto. No existe. O, si existe, lo hace dentro de uno de estos juegos. Existe tanto y como se juegue, no? | No confundir catálogo cultural con plataforma cerrada. |
...
"Periferia" (Ratos de sótano)
**"Periferia" (Ratos de porao)**

todo sucede en la periferia
**tudo acontece na perifeira**
peleas, muertes en la periferia
**brigas, mortes na periferia**
tiros, sangre en la periferia, en la periferia
**tiros, sangue na periferia, na periferia**
todo acontece en la periferia.
**tudo acontece na periferia**.

todo corre directo hacia la periferia
**bagulho corre direto na periferia**
hacemos mucha anarquía en la periferia, en la periferia
...
```
flowchart TD
  Corpus["Corpus / canon versionable"]
  Contexto["Ventana de contexto"]
  Futuros["Grafo de futuros"]
  Obra["@voz / pieza dramatizada"]

  Canon["Canon compartido<br/>memoria estable"]
  Invocacion["Invocación por agentes<br/>context window"]
  Agencia["Decisiones y misiones<br/>ramas jugables"]
  Drama["Momento dramático<br/>drop narrativo"]
  Rastro["Rastro transmedia<br/>bots, posts, pistas, pubs"]

  Comunidad["Personas que juegan"]
  Hallazgos["Hallazgos, respuestas,<br/>teorías, comandos"]
  Triage["Triage editorial<br/>canon / rumor / propuesta / descarte"]

  Corpus --> Canon --> Comunidad
  Contexto --> Invocacion --> Comunidad
  Futuros --> Agencia --> Comunidad
  Obra --> Drama --> Comunidad
  Canon --> Rastro
  Agencia --> Rastro
  Drama --> Rastro
  Rastro --> Hallazgos
  Comunidad --> Hallazgos
  Hallazgos --> Triage
  Triage -->|canoniza| Corpus
  Triage -->|ajusta| Contexto
  Triage -->|abre rama| Futuros
  Triage -->|descarta con motivo| Rastro
```
![Fallback chart 03](analisis_transmedia_system_PICS/CHARTS_03.png)
...
## Vale, sí, muy bonito. ¿Pero qué pinta tiene una party de estas?
...
```
flowchart LR
  subgraph Local["Barrios digitales / peers locales"]
    StreamDesk["StreamDesktop<br/>Kick / streaming"]
    BotHub["BotHubSDK<br/>Telegram / IACM"]
    Agent["Peer Client<br/>agente o herramienta local"]
    Browser["UI / panel local"]
  end

  subgraph VPS["VPS / punto de encuentro"]
    Caddy["Caddy proxy<br/>TLS + WSS 443"]
    Rooms["Pub.Rooms<br/>vestíbulo layer2"]
    Mesh["Room mesh<br/>Socket.IO / Node-RED"]
    Health["Health + logs<br/>observabilidad"]
  end

  subgraph Runtime["Runtime transmedia"]
    FPE["Future Pipeline Engine"]
    Firehose["Firehoses MCP<br/>raw buffers + cursores"]
    Presets["Zeus PRESETS"]
    Corpus["Corpus / BOE / contexto"]
  end

  StreamDesk -->|WSS saliente 443| Caddy
  BotHub -->|WSS saliente 443| Caddy
  Agent -->|WSS saliente 443| Caddy
...
Fallback histórico: [analisis_transmedia_system_PICS/CHARTS_04.png](analisis_transmedia_system_PICS/CHARTS_04.png)
![Fallback chart 04](analisis_transmedia_system_PICS/CHARTS_04.png)
...
stateDiagram-v2
  [*] --> Preproduccion
  Preproduccion --> RoomPreparada: contrato de sesión + ventana inicial
  RoomPreparada --> PeerCardsEmitidas: Equipo de Ceremonias invita peers
  PeerCardsEmitidas --> Soundcheck: presencia + capabilities
  Soundcheck --> SesionActiva: launch-session

  state SesionActiva {
    [*] --> ConexionViva
    ConexionViva --> CapturaEventos: stream/chat/bots
    CapturaEventos --> EdicionContexto: triage + ventana viva
    EdicionContexto --> Bifurcacion: futuros + decisiones
    Bifurcacion --> PropagacionEnVivo: drops/pistas/respuestas
    PropagacionEnVivo --> ConexionViva: feedback
  }

  SesionActiva --> CierreEditorial: Equipo de Ceremonias cierra Room
  CierreEditorial --> Publicacion: corpus + @voz + grafo
  Publicacion --> InterSesion: bots, pistas, misiones, archivo
  InterSesion --> Preproduccion: siguiente sesión
  CierreEditorial --> Archivo: snapshot + logs + evidencias
  Archivo --> [*]
```
![Fallback chart 05](analisis_transmedia_system_PICS/CHARTS_05.png)
...
| Fase | Pregunta de control | Artefacto mínimo |
|------|---------------------|------------------|
| **Preproducción** | ¿Qué se juega, quién conduce y qué puede cambiar? | Contrato de sesión, ventana inicial, roles, criterios de canon. |
| **Room preparada** | ¿Existe un lugar técnico común y observable? | Room, endpoint, health check, fallback de comunicación. |
| **Peer Cards emitidas** | ¿Cada participante tiene permisos mínimos suficientes? | Tokens con scopes, expiración, identidad visible. |
| **Soundcheck** | ¿La señal entra y las capacidades responden? | Prueba de stream/chat, capabilities, STT si aplica, firehose cursors. |
| **Sesión activa** | ¿El sistema captura sin ahogar el directo? | Eventos normalizados, ventana en edición, bitácora, decisiones de turno. |
| **Cierre editorial** | ¿Qué queda canonizado, qué queda abierto y qué se descarta? | Snapshot de contexto, corpus, descartes, resumen de decisiones. |
| **Publicación** | ¿Qué se lleva la comunidad? | Obra/@voz, grafo de futuros, misiones, memoria compartible. |
| **Inter-sesión** | ¿Cómo vuelve la calle digital al tablero? | Bots activos, pistas, capturas de feedback, nuevas semillas. |
| **Archivo** | ¿Puede auditarse o reconstruirse lo esencial? | Logs, evidencias, versiones, enlaces, hashes si procede. |

### Líneas concurrentes durante la sesión

| Línea | Qué sostiene | Componentes típicos | Señal de alerta |
|-------|--------------|---------------------|-----------------|
| **Presencia** | Keep-alive, conexión, membresía de Room. | Pub.Rooms, Caddy, WSS, room mesh. | Peers fantasma, reconexiones sin cursor, tokens no revocados. |
| **Captura** | Stream, chat, bots, firehoses. | `media-extraction`, `MCPFirehoseServer`, `MCPBotHubServer`. | Eventos sin timestamp, transcripción sin fuente, pérdida de contexto. |
| **Edición** | Ventana viva, triage, decisiones. | Elenco, Equipo de Ceremonias, Document Machine. | Canonización automática, duplicados, ruido premiado por volumen. |
| **Futuros** | Bifurcaciones y agencia. | `futures-engine`, Future Machine, @voz. | Demasiadas ramas, ramas sin consecuencia, elección cosmética. |
| **Propagación** | Drops, pistas, respuestas externas. | Rude bots, BotHubSDK/IACM, canales federados. | Bots sin identidad, pistas sin retorno, spam transmedia. |

## Scriptorium: la enésima blockchain

**Nota editorial:** los diagramas son mapas de orientación. No son fuente de verdad por sí mismos. 

```
flowchart TD
  subgraph Gobierno["Gobierno de sesión"]
    EDC["Equipo de Ceremonias<br/>Arrakis Theater"]
    Zeus["Zeus / Operator<br/>PRESETS + capacidades"]
    DevOps["DevOps / Crew<br/>salud + transporte"]
  end

  subgraph Entrada["Señal viva"]
    Stream["Stream en vivo<br/>audio/video + chat"]
    Elenco["Elenco / artistas<br/>edición de ventana"]
    Comunidad["Personas que juegan<br/>chat, comandos, hallazgos"]
    Bots["Rude bots / skins<br/>canales externos"]
  end

  subgraph Sala["Room federada"]
    PeerCard["Peer Card<br/>token, scopes, expiración"]
    Room["PUBLIC_ROOM / rooms federadas"]
    Firehoses["Firehoses<br/>stream chat, BotHub, ATProto, rooms"]
  end

  subgraph Core["Orquestación transmedia"]
    FPE["Future Pipeline Engine<br/>router de señales + skills"]
    Contexto["Ventana de contexto viva<br/>canon en edición"]
    Ledger["Bitácora de evidencias<br/>timestamps, cursores, procedencia"]
  end

  subgraph Salidas["Artefactos de sesión"]
    Corpus["Lore / corpus versionable"]
    Futuros["Grafo de futuros<br/>2–5 bifurcaciones útiles"]
    Voz["Obra / @voz<br/>cristalización dramatúrgica"]
    Propagacion["Rastro transmedia<br/>pistas, bots, publicaciones"]
  end

  EDC -->|crea reglas, turnos y cierre| Room
  EDC -->|emite y revoca| PeerCard
  Zeus -->|habilita/corta herramientas| FPE
  DevOps -.->|Caddy, WSS, observabilidad| Room
  DevOps -.->|salud, logs, backups| Firehoses
  ...
  Bots --> Firehoses
  Elenco --> Contexto
  Firehoses -->|eventos normalizados| FPE
  Room -->|capabilities + presencia| FPE

  FPE -->|rutea por skills| Corpus
  FPE -->|detecta bifurcaciones| Futuros
  Contexto -->|criterio editorial| Corpus
  Contexto -->|condiciona prompts y bots| Propagacion
  Ledger -->|pruebas y trazabilidad| Corpus
  Corpus --> Voz
  Futuros --> Voz
  Voz --> Propagacion
  Propagacion -->|feedback entre sesiones| Firehoses
```

[analisis_transmedia_system_PICS/CHARTS_01.png](analisis_transmedia_system_PICS/CHARTS_01.png)

![Fallback chart 01](analisis_transmedia_system_PICS/CHARTS_01.png)
...
<table>
  <tr>
    <td align="center"><img src="./SCRIPTORIUM-SPOT/BRANDING/SCRIPTORIUM_SKINS_PRODUCT.png" alt="Producto Scriptorium Skins" width="320"><br><sub><b>El producto o cosa tangible</b> — Un motor de juegos como espacio ARG Transmedia</sub></td>
    <td align="center"><img src="./SCRIPTORIUM-SPOT/BRANDING/SKIN_TRADS.png" alt="Detalles Scriptorium Skins" width="320"><br><sub><b>Los rude bots skin</b> — Identidades operativas de un "cierto" campo conceptual que hereda y sigue la tradición skin. Son avatares o "profiles" para Web 4.0 a modo de marionetas digitales.</sub></td>
  </tr>
  <tr>
    <td align="center"><img src="./SCRIPTORIUM-SPOT/BRANDING/SCRIPTORIUM_CARD_PUB.png" alt="Tarjeta de Pub federado" width="320"><br><sub><b>El tablero ARG</b> — hub/pub para entretejer la red</sub></td>
    <td align="center"><img src="./SCRIPTORIUM-SPOT/BRANDING/SCRIPTORIUM_CARD_ROOMS.png" alt="Tarjeta de Rooms" width="320"><br><sub><b>Las pistas de baile</b> — el camión llega a tu barrio con los enganches de federación</sub></td>
  </tr>
</table>
...
<img src="./analisis_transmedia_system_PICS/TROJAN_LOGO.png" alt="Sello Trojan kins" width="110"> ---> <img src="./SCRIPTORIUM-SPOT/BRANDING/SCRIPTORIUM_SKINS.png" alt="Sello Scriptorium Skins" width="110">
...
## Sello & T.A.Z.'ing'roll

### Transmedia System para Zonas Autónomas

El Transmedia-System es un motoro ARG para preservar una ventana de contexto en el tiempo y la web pudiéndose recupear como un "adn" para decoherencia en eventos y sesiones. Aunque usa los típicos “un bot que habla” o “un bot que hace tareas” de los proyectos de IA aquí el bot se customiza al modo scriptorium-skin para convertirse en una suerte de pseudo-heterónio. En el reparto de responsabilidades entre personas, máquinas, canales y artefactos vemos 3 holones en la espiral de la evolución de la Web: 1.0 (documentos), 2.0 (avatares & contenido), 3.0 (automatización & blockchians), 4.0 (presente). El sistema para transitir la narrativa de juegos de realidad alternativa, llamamos: Transmedia System. Una Zona Autónoma Transmedia es una cristalización que hace eigenstate y decohere.

| Rol | Responsabilidad primaria | Entregables | Límites sanos |
|-----|--------------------------|-------------|---------------|
| **Equipo de Ceremonias / Arrakis Theater** | Diseñar y conducir la sesión. Abre Room, reparte Peer Cards, fija turnos, marca hitos, cierra el ciclo. | Contrato de sesión, reglas de juego, agenda, decisiones de canon, cierre editorial. | No debería escribirlo todo ni convertirse en cuello de botella narrativo. Su función es dirigir el flujo. |
| **Elenco / artistas de transmedia** | Mantener viva la ventana de contexto: añadir, refactorizar, descartar, matizar tono, cuidar personajes y reglas internas. | Ventana de contexto versionada, notas de escena, prompts operativos, criterios de interpretación. | No debe confundir improvisación con canon automático. Toda edición relevante necesita procedencia. |
| **Streamer + invitados** | Emitir la señal viva: conversación, performance, debate, juego, demostración o ritual narrativo. | Stream, chat asociado, momentos de decisión, materiales de escena. | No tiene que operar la infraestructura. Debe poder participar desde su entorno habitual. |
| **Zeus / Operator + PRESETS** | Gobernar capacidades: qué herramientas están disponibles, con qué permisos, para qué fase y bajo qué preset. | Packs de capacidades, presets de sesión, reglas de activación, cortes de seguridad. | No decide el canon; decide el rango técnico de lo que puede ocurrir. |
| **Dramaturgo / Demiurgo / @voz** | Cristalizar el material en obra: transformar corpus y futuros en piezas legibles, memorables y reutilizables. | Escenas, resúmenes, voces, manifiestos, fragmentos dramatizados, sinopsis de futuros. | No debe inventar fuera de evidencias salvo que lo marque como ficción/propuesta. |
| **DevOps / Crew** | Montar y vigilar el muro: transporte WSS, Caddy, Pub.Rooms, salud, logs, backups, observabilidad. | Infra lista, endpoints, métricas, alertas, plan de caída, recuperación. | No modera la historia; protege la continuidad técnica de la sesión. |
| **Personas que juegan / comunidad** | Intervenir, elegir, descubrir, contrastar, llevar pistas a otros canales y devolver hallazgos. | Mensajes, comandos, decisiones, evidencias, hipótesis, respuestas a pistas. | No son “audiencia pasiva”, pero tampoco todo input debe entrar al corpus. |
| **Rude bots / skins** | Operar como identidades funcionales al modo de avatares en la Web 2.0; para activarse en canales externos: mensajería, recordatorios, compactación, archivo, agitprop lúdico, pistas. | Eventos normalizados, mensajes, resúmenes, enlaces de retorno, señales entre sesiones. | Deben ser trazables, revocables y coherentes con la ventana de contexto.  |
...
## Escena: catálogo de juegos previstos
...
<table>
  <tr>
    <td align="center" width="25%" valign="top">
      <img src="./SCRIPTORIUM-SPOT/BRANDING/SCRIPTORIUM_SKINS.png" alt="Portada — IA Builder" width="100%"><br>
    ...
    <td align="center" width="25%" valign="top">
      <img src="./SCRIPTORIUM-SPOT/BRANDING/SCRIPTORIUM_SKINS.png" alt="Portada — Hiper-debates" width="100%"><br>
      <b>② ARG Player (Pista de Dances para personas jugadoras)</b><br>
      <sub><i>Artistas que suben a su representante al escenario</i></sub>
    </td>
    <td align="center" width="25%" valign="top">
      <img src="./SCRIPTORIUM-SPOT/BRANDING/SCRIPTORIUM_SKINS.png" alt="Portada — El Juego del Bot" width="100%"><br>
    ...
    <td align="center" width="25%" valign="top">
      <img src="./SCRIPTORIUM-SPOT/BRANDING/SCRIPTORIUM_SKINS.png" alt="Portada — Regulador de Distribución" width="100%"><br>
...
| Capa | Responsabilidad | Componentes visibles en el ecosistema | Contrato mínimo |
|------|-----------------|----------------------------------------|-----------------|
| **Captura** | Convertir señales de participantes en eventos consumibles. | `StreamDesktop`, chats de stream, `MCPFirehoseServer`, `MCPBotHubServer`, bots externos. | Emitir eventos con origen, autor/canal, timestamp, payload y cursor o referencia incremental. |
| **Transporte** | Permitir presencia y comunicación federada sin puertos entrantes. | Caddy, WSS 443, `Pub.Rooms`, rooms Socket.IO, ScriptoriumVps. | Conexión saliente, tokens revocables, keep-alive, reconexión y observabilidad. |
| **Normalización** | Unificar stream, chat, room, bot y firehose en una forma común. | Flujos RxJS/Node-RED, `WiringEditor`, adaptadores MCP. | Separar evento bruto, evento normalizado y decisión editorial. |
| **Orquestación** | Enrutar eventos hacia skills, presets, memoria y salidas. | Future Pipeline Engine, Zeus/PRESETS, MCP-SDK. | Aplicar políticas de capacidad y registrar qué herramienta produjo qué resultado. |
| **Procesamiento** | Extraer texto, ordenar, resumir, bifurcar, diagnosticar. | `media-extraction`, `futures-engine`, `engine-plan`, Document Machine/BARTLEBY. | Producir resultados revisables, con input rastreable y estado reproducible cuando sea razonable. |
| **Memoria editorial** | Mantener el canon y la ventana de contexto. | Corpus versionable, BOE/bloques editoriales, repositorio documental. | Distinguir canon, hipótesis, rumor, propuesta y descarte. |
| **Cristalización** | Convertir corpus y bifurcaciones en obra o artefacto publicable. | Dramaturgo/@voz, Future Machine, prompts de universo. | Declarar registro, fuentes usadas y grado de ficción. |
| **Propagación** | Sacar la trama al tejido transmedia y traer feedback. | Rude bots, BotHubSDK/IACM, Telegram, redes, pubs, rooms. | Publicar con identidad clara, respetar alcance de sesión y devolver eventos al pipeline. |
...
<table>
  <tr>
    <td align="center" width="25%"><img src="SCRIPTORIUM-GAMES/GAME-04-NETWORK-TOPOLOGIST/MAX_PIC_01.png" alt="Regulador — escena 1" width="100%"><br><sub>Escena 1 · planteamiento del experimento</sub></td>
    <td align="center" width="25%"><img src="SCRIPTORIUM-GAMES/GAME-04-NETWORK-TOPOLOGIST/MAX_PIC_02.png" alt="Regulador — escena 2" width="100%"><br><sub>Escena 2 · topología y graduación</sub></td>
    <td align="center" width="25%"><img src="./SCRIPTORIUM-GAMES/GAME-04-NETWORK-TOPOLOGIST/MAX_PIC_03.png" alt="Regulador — escena 3" width="100%"><br><sub>Escena 3 · ciclos en marcha</sub></td>
    <td align="center" width="25%"><img src="./SCRIPTORIUM-GAMES/GAME-04-NETWORK-TOPOLOGIST/MAX_PIC_04.png" alt="Regulador — escena 4" width="100%"><br><sub>Escena 4 · lectura del reparto</sub></td>
  </tr>
</table>
