...
- `NETWORK_ENGINE.instructions.md`: análisis técnico global y composition root.
- `ECOSYSTEM.md`: matriz de trazabilidad Conceptual ↔ Física y plan de migración SDK legacy.
- `CORE.instructions.md`: análisis técnico del core (incl. builder puro `KnowledgeSystem`, [ADR 0009](../../ADR/0009-knowledge-system-mcp-app-builder.md)).
- `NODE.instructions.md`: análisis técnico del runtime Node.
...
- `MONGO.instructions.md`: adaptador MongoDB de `DocumentStoreProtocol`.
- `GRAPHQL.instructions.md`: proyección GraphQL desde `DomainContract` ([ADR 0006](../../ADR/0006-graphql-projection.md)).
