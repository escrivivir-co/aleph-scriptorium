...
Este directorio contiene los ejes temáticos fundamentales que operan como **vacuna anti-naïf** y **brújula analítica** del proyecto. Cada documento extrae y reescribe material del diálogo fundacional, traduciendo preguntas ingenuas en mecanismos y arquitecturas institucionales.

---

## Contenidos

### [01. Selección sistémica](01-seleccion-sistemica.md)
Posición estructural, asimetría institucional, captura regulatoria. Por qué el éxito no es inteligencia sino posición. El sistema premia al más integrado, no al más listo.

### [02. Injusticias corregidas vs emergentes](02-injusticias-corregidas-emergentes.md)
Qué corrigió la historia y qué persiste. Por qué no hay "solución final" en sistemas complejos. Propiedades emergentes y efecto Mateo.

### [03. Acción colectiva y vida personal](03-accion-colectiva-vida-personal.md)
Free rider, ley de hierro de la oligarquía. Por qué la precariedad no genera transformación sino agotamiento. Formas de vida que sostienen el conflicto.

### [04. Geopolítica y sistema-mundo 2025](04-geopolitica-sistema-2025.md)
Multipolaridad, estabilidad vs legitimidad. El sistema como conjunto de equilibrios inestables que prioriza evitar colapsos sobre maximizar justicia. Margen de maniobra estrecho.

### [05. Método materialista actualizado](05-metodo-materialista-actualizado.md)
Marx/Engels en 2025. El proletariado fragmentado, el capital abstracto, el Estado como administrador del riesgo. Abandono de la teleología; búsqueda de contradicciones materiales efectivas.

### [06. Soberanía y voluntad general](06-soberania-voluntad-general.md)
Rousseau en 2025. Por qué la revolución clásica no encuentra objeto. Re-politización de lo técnico, reconstrucción de cuerpos deliberativos, igualdad como condición de libertad.
...
- **Establecer el marco analítico** de cada capítulo.
- **Evitar moralina**: traducir indignación en arquitectura institucional.
- **Evitar nostalgia revolucionaria**: aceptar que el horizonte es más estrecho, sin resignarse.
- **Formular preguntas correctas**: no "¿cómo derrocamos el sistema?" sino "¿dónde están las contradicciones materiales efectivas?" y "¿qué formas de vida sostienen la acción prolongada?".

---

## Origen

Material extraído y reescrito del documento fundacional `objetos.md`, que recoge un diálogo sobre rescates, impunidad sistémica, y la pregunta de época: si las injusticias estructurales persisten, ¿qué tiene sentido hacer?

La respuesta corta: **no se trata de elegir entre vida personal y transformación, sino de diseñar condiciones materiales que permitan sostener ambas**.
